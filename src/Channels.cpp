...
namespace proto {
    ...
    const std::map<ChannelType, Channel> CHANNELS = {
            ...
            {AI_SETTINGS_RECEIVE,              {"ai_settings_receive",     "...",       "0"}},
            {AI_DRAW_SEND,                     {"ai_draw_send",            "...",       "0"}},
            {INTERFACE_SETTINGS_SEND,          {"interface_settings_send", "...",       "0"}},
            {INTERFACE_DRAW_RECEIVE,           {"interface_draw_receive",  "...",       "0"}}
    };
